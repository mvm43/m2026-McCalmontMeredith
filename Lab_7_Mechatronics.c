...
int main(void)
{
	...
	//From Clark's code
	DDRD = 1<<PORTD0 | 1<<PORTD1 | 1<<PORTD6;// Make OC0A (PD6) and OC0B (PD5) output bits -- these are the PWM pins; 
	// this is the same as DDRD = 0b01000011;
	...
	TCCR0B = 0b00000010; //0<<CS02 | 1<<CS01 | 1<<CS00; // Set base PWM frequency (CS02:0 - bits 2-0 = 011 for prescaler of 64, for approximately 1kHz base frequency)
